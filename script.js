...
function draw() {	
  ...
  translate(-w, -h/4);
	...
	fill(terrainValues.terrainColor[0] * 1, terrainValues.terrainColor[1] * 1, terrainValues.terrainColor[2] * 1, (terrainValues.terrainOpacity * 100));
